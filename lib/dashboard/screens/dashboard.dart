      ...
      builder: (context){
        ...
        appBar: AppBar(
          ...
          title:RichText(text: const TextSpan(
            ...
            TextSpan(
            text: 'Student Portal',style: TextStyle(color: Colors.white,
            fontSize:23 ,
            // fontWeight: FontWeight.bold,
            fontFamily: 'Poppins',)
          ),
                          ...
                          child: Column(children: [
                            Row(children: [
                             ...
                             const SizedBox(width: 20,),
                              Text('Munir Tabassum'.toUpperCase(),style: const TextStyle(
                        ...
                        child: Column(children: [
                          Padding(
                            ...
                            child: Row(children: const [
                              SizedBox(width: 20,),
                               Text('Course overview',style:  TextStyle(
                              color: Colors.deepPurple,
                            ...
                            child: Container(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: ((context, index) {
                                  return ListTile(
                                  title:  Text('${courseList[index].id}'),
